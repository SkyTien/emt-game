...
This project is indexed by GitNexus as **emt-game** (818 symbols, 1164 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource                                  | Use for                                  |
| ----------------------------------------- | ---------------------------------------- |
| `gitnexus://repo/emt-game/context`        | Codebase overview, check index freshness |
| `gitnexus://repo/emt-game/clusters`       | All functional areas                     |
| `gitnexus://repo/emt-game/processes`      | All execution flows                      |
| `gitnexus://repo/emt-game/process/{name}` | Step-by-step execution trace             |
